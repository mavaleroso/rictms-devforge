...
const colors = {
  ...
  violet: [
    '[--switch-bg-ring:var(--color-brand-600)]/90 [--switch-bg:var(--color-brand-500)] dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:var(--color-brand-600)]/90 [--switch-shadow:var(--color-brand-900)]/20',
  ],
  purple: [
